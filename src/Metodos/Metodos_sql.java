...
//    public static String buscarTipoEmpleado(String nusuario) {
//
...
//        try {
//            conexion = ConexionBD.conectar();
//            String sentencia_buscar = ("SELECT Nombres, Apellidos, TipoEmpleado FROM empleado WHERE Usuario = '" + nusuario + "'");
//            sentencia_preparada = conexion.prepareStatement(sentencia_buscar);
//            resultado = sentencia_preparada.executeQuery();
//            if (resultado.next()) {
//                String Tipo_Empleado = resultado.getString("TipoEmpleado");
//                busqueda_Rol = (Tipo_Empleado);
//            }
//            conexion.close();
//
//        } catch (Exception e) {
...
//        try {
//            conexion = ConexionBD.conectar();
//            String buscarInvitado = ("SELECT Nombres, Usuario, clave, TipoEmpleado  FROM empleado WHERE Usuario = '" + user + "' AND clave = '" + pass + "' AND TipoEmpleado = '" + tipo + "'");
//            sentencia_preparada = conexion.prepareStatement(buscarInvitado);
//            resultado = sentencia_preparada.executeQuery();
//            if(resultado.next()){
//                buscarEmpleado = "USUARIO ENCONTRADO";
//            }else {
//                buscarEmpleado = "USUARIO NO ENCONTRADO";
//            }
//            conexion.close();
//            
//        } catch (Exception e) {
